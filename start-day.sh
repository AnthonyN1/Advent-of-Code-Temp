...
curl -A "https://github.com/AnthonyN1/Advent-of-Code by anthonyjnool@gmail.com" "https://adventofcode.com/$1/day/$2/input" -b "session=${session}" --create-dirs -o $out_file
